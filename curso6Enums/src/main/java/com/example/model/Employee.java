...
public class Employee {
    ...
    private String name;
    private Integer age;
    /*Un enumerado puede guardar los datos como int o como string. Si no le especificas nada los guardara como int
    * y le tienes que añadir EnumType.STRING para que guarde el valor que se le asigna a cada posicion del enum*/

...
public class QueriesTest {
    ...
    void findByEmail(){
        ...
        var query = session.createQuery(jpql, Author.class);
        query.setParameter("email", "a2@gmail.com");
    ...
    void findByAddressCity(){
        insertData();
        var session = HibernateUtil.getSessionFactory().openSession();
        String jpql = "SELECT a FROM Author a WHERE a.address.city IN :city";
        var query = session.createQuery(jpql, Author.class);
    ...
    void update(){
        ...
        //createQuery
        int update = session.createMutationQuery(jpql)
                .setParameter("name", "Yunna")
                .setParameter("id", 1)
                .executeUpdate();
        session.getTransaction().commit();

        System.out.println("Authors update: "+update);
    }
    ...
    void insertData(){
        ...
        var author1 = new Author ("author1", "a1@gmail.com", LocalDate.of(1990, 1, 1));
        var author2 = new Author ("author2", "a2@gmail.com", LocalDate.of(1995, 1, 1));
        var author3 = new Author ("author3", "a3@gmail.com", LocalDate.of(2000, 1, 1));
